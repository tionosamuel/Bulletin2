    ...
    <form method="POST" wire:submit.prevent="update">
        ...
        <div class="p-5 flex flex-col gap-4">
            <div class="block mb-5">
                <p>Matricule</p>
                <a-jet-label value="{{ __('Matricule') }}" />
                <input type="text"
        ...
        @enderror"
            ...
            <div class="block mb-5">
                <p>Genre</p>
                <a-jet-label value="{{ __('Genre') }}" />
                <input type="text"
                    class="block mt-1 rounded-md border-gray-300 w-full @error('genre')
            border-red-500 bg-red-100 animate-bounce
        @enderror"
                    wire:model="genre" name="genre">
            ...
            <div class="block mb-5">
                ...
                <a-jet-label value="{{ __('Date de naissance') }}" />
                <input type="date"
            ...
            <div class="block mb-5">
                <p>Contact du parent</p>
                <a-jet-label value="{{ __('Contact du parent') }}" />
                <input type="text"
                    class="block mt-1 rounded-md border-gray-300 w-full @error('prenom')
                        border-red-500 bg-red-100 animate-bounce
                    @enderror"
